...
const SimpleBar = (function () {
  ...
  const getOptions$1 = function (obj) {
    const initialObj = {};
    const options = Array.prototype.reduce.call(obj, function (acc, attribute) {
      const option = attribute.name.match(/data-simplebar-(.+)/);
      if (option) {
        const key = option[1].replace(/\W+(.)/g, function (_, chr) { return chr.toUpperCase(); });
  ...
  const getElementWindow = getElementWindow$1;
  const getElementDocument = getElementDocument$1;
  const getOptions$2 = getOptions$1;
  const addClasses$2 = addClasses$1;
  const removeClasses = removeClasses$1;
  const classNamesToQuery = classNamesToQuery$1;
  const SimpleBarCore = /** @class */ (function () {
    function SimpleBarCore (element, options) {
      ...
      this.onPointerEvent = function (e) {
        if (!_this.axis.x.track.el ||
					...
					!_this.axis.y.scrollbar.el) { return; }
      ...
      this.drag = function (e) {
        ...
        const trackSize = (_b = (_a = track.rect) === null || _a === void 0 ? void 0 : _a[_this.axis[_this.draggedAxis].sizeAttr]) !== null && _b !== void 0 ? _b : 0;
        const scrollbar = _this.axis[_this.draggedAxis].scrollbar;
        const contentSize = (_d = (_c = _this.contentWrapperEl) === null || _c === void 0 ? void 0 : _c[_this.axis[_this.draggedAxis].scrollSizeAttr]) !== null && _d !== void 0 ? _d : 0;
        const hostSize = parseInt((_f = (_e = _this.elStyles) === null || _e === void 0 ? void 0 : _e[_this.axis[_this.draggedAxis].sizeAttr]) !== null && _f !== void 0 ? _f : "0px", 10);
        e.preventDefault();
        e.stopPropagation();
    ...
    SimpleBarCore.getRtlHelpers = function () {
      ...
      const dummyChild = scrollbarDummyEl === null || scrollbarDummyEl === void 0 ? void 0 : scrollbarDummyEl.firstElementChild;
    ...
    SimpleBarCore.prototype.initListeners = function () {
      ...
      if (window.ResizeObserver) {
        ...
        let resizeObserverStarted_1 = false;
    ...
    SimpleBarCore.prototype.getScrollbarSize = function (axis) {
      ...
      const trackSize = (_b = (_a = this.axis[axis].track.el) === null || _a === void 0 ? void 0 : _a[this.axis[axis].offsetSizeAttr]) !== null && _b !== void 0 ? _b : 0;
    ...
    SimpleBarCore.prototype.positionScrollbar = function (axis) {
      ...
      const trackSize = ((_a = this.axis[axis].track.el) === null || _a === void 0 ? void 0 : _a[this.axis[axis].offsetSizeAttr]) || 0;
    ...
    SimpleBarCore.prototype.onTrackClick = function (e, axis) {
      ...
      this.axis[axis].scrollbar.rect =
				currentAxis.scrollbar.el.getBoundingClientRect();
      const scrollbar = this.axis[axis].scrollbar;
      const scrollbarOffset = (_b = (_a = scrollbar.rect) === null || _a === void 0 ? void 0 : _a[this.axis[axis].offsetAttr]) !== null && _b !== void 0 ? _b : 0;
      const hostSize = parseInt((_d = (_c = this.elStyles) === null || _c === void 0 ? void 0 : _c[this.axis[axis].sizeAttr]) !== null && _d !== void 0 ? _d : "0px", 10);
  ...
  const _a = SimpleBarCore.helpers;
  const getOptions = _a.getOptions;
  const addClasses = _a.addClasses;
  const SimpleBar = /** @class */ (function (_super) {
              ...
              addedNode
                ...
                .forEach(function (el) {
                  if (el.getAttribute("data-simplebar") !== "init" &&
										...
										document.documentElement.contains(el)) { new SimpleBar(el, getOptions(el.attributes)); }
                });
            }
          }
        });
